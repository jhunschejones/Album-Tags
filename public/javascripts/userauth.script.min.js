...
element.style.display="none"}catch(error){console.log("element id: "+elementId+"error: "+error)}}
function showDOMelement(elementId){try{let element=document.getElementById(elementId)
element.style.display="block"}catch(error){console.log("element id: "+elementId+"error: "+error)}}
